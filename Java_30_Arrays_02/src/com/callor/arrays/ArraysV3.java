...
public class ArraysV3 {
	...
	public static void main(String[] args) {
		...
		// index 변수의 값이 0이므로 intNums[0]과 코드가 된다
		// index라는 변수를 사용하여 첨자를 지정함으로써
		 ...
		 * 배열.length는 배열을 생성하면 배열의 개수를 보관하도록 자동으로 만들어지는
		 * 		특별한 변수이다
		 * 
		...
		// intScore 배열의 0번부터 intScore.length - 1 번까지의
