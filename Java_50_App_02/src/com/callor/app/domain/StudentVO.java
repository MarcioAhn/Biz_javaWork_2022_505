...
public class StudentVO {
	 ...
	 * 도구들마다 VO 객체에 객체에 접근하는 방법이 조금씩 다르다
	 * 
	 * 어떤 도구는 getter, setter를 통하여 접근하기도 하고
	 * 어떤 도구는 필드생성자를 통하여 접근하기도 한다
	 * 
	 * 최근에는 getter, setter를 만들지 말자라는 의견이 있지만
	 * 다양한 JDK 도구를 사용할 때는 필요하므로
	 * 표준 Java 코딩의 VO 클래스의 작성 패턴에서는
	 * 모든 변수는 private으로 선언하고 getter, setter를 정의해 준다
	 */
	...
	// VO 객체에 데이터를 저장한 후
	// 저장된 데이터가 담겼는지 잘 담겼는지 확인하는 용도로 사용하기 위하여
