...
public class Var_01 {
	 ...
	 * 표기: main()
	 * main()는 public static void키워드와 한 그룹으로 사용되면 마치 키워드처럼 작동된다
	 * public static void main() {}
	 * 		Java 시작점, 진입점 method 명령 그룹 이라고 한다
	 * 초기에 Java Project를 시작할 때는 반드시 main(){}블럭에서 부터 코드가 시작되어야 한다
	 * 
	 */

	public static void main(String[] args) {
		
		// 숫자형 변수는 선언할 때 최소한 0으로 값을 할당하자
		 ...
		 * 
		 * 빈칸으로 조합된 키워는 사용 용도에 따라 많은 경우의 수가 있다
		 * public static void main()
		 * public void main()
		 * pub int main()
		 * 등등 사용법이 다양하다
		...
		//		없으면 문법 오류를 발생하기도 한다
		// method에 첨가되는 args는 method코드가 만들어질 때
		// 		정해지는 것으로 특별한 규칙이 없다
