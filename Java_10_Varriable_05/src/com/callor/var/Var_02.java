...
public class Var_02 {
	public static void main(String[] args){
		...
		double douDe = douNum1 - douNum2;
		double douPro = douNum1 * douNum2;
		double douDi = douNum1 / douNum2;
		 ...
		 * 그런데 douNum1, douNum2, doSum 변수는 double type 이다
